...
async def async_setup_entry(hass, config_entry):
    ...
    equipment = await api.get_equipment_by_type([EquipmentType.WATER_HEATER, EquipmentType.THERMOSTAT])
...
class EcoNetEntity(Entity):
    ...
    def device_state_attributes(self):
        ...
        _attr = {ATTR_ON_VACATION: self._econet.vacation, ATTR_IN_USE: self._econet.running}
