...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities(
        [EcoNetWaterHeater(water_heater) for water_heater in equipment[EquipmentType.WATER_HEATER]],
    )
...
class EcoNetWaterHeater(EcoNetEntity, WaterHeaterEntity):
    ...
    def on_update_received(self):
        ...
        super(EcoNetWaterHeater, self).on_update_received()
    ...
    def device_state_attributes(self):
        ...
        if self.water_heater.tank_hot_water_availability:
            _attr[ATTR_TANK_HOT_WATER_AVAILABILITY] = self.water_heater.tank_hot_water_availability
